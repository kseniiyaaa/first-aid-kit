...
export default function EditReminderPage() {
    ...
    useEffect(() => {
        if (!id) return;
        authFetch(`/api/reminders/${id}`)
            .then((r) => r.json())
            .then((reminder) => {
                if (!reminder || !reminder.id) { setNotFound(true); return; }
                const { date: d, time: t } = parseRemindAt(reminder.remind_at);
                setDate(d);
                setTime(t);
            ...
            <div className="pill-form">
                ...
                <div className="pill-form-row">
                    <div className="pill-form-field">
                        ...
                        />
                        {errors.date && (
                            <span className="pill-form-field-error">{errors.date}</span>
                        )}
                    </div>
                    <div className="pill-form-field">
                        <label className="pill-form-label">
                        ...
                        />
                        {errors.time && (
                            <span className="pill-form-field-error">{errors.time}</span>
                        )}
                    </div>
                </div>
                ...
                {isRecurring && (
                    <div className="pill-form-field">
                        ...
                        />
                        {errors.endDate && (
                            <span className="pill-form-field-error">{errors.endDate}</span>
                        )}
                    </div>
                )}
